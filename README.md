...
Once you have a gene or genes of interest, you can explore the data available (eg mutation, mutation, copy number variation and clinical characteristics) in public cancer datasets.
